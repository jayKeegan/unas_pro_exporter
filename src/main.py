...
# Get metric prefix from environment variable (default: 'unas_')
METRIC_PREFIX = os.getenv("METRIC_PREFIX", "unas_")

device_name = Gauge(f'{METRIC_PREFIX}device_name', 'Device Name', registry=registry, labelnames=['name'])
cpu_usage = Gauge(f'{METRIC_PREFIX}cpu_usage', 'CPU Usage (%)', registry=registry)
cpu_temperture = Gauge(f'{METRIC_PREFIX}cpu_temperature', 'CPU Temperture (°C)', registry=registry)
memory_free = Gauge(f'{METRIC_PREFIX}memory_free', 'Memory Free', registry=registry)
memory_used = Gauge(f'{METRIC_PREFIX}memory_used', 'Memory Used', registry=registry)
memory_total = Gauge(f'{METRIC_PREFIX}memory_total', 'Memory Total', registry=registry)
memory_usage = Gauge(f'{METRIC_PREFIX}memory_usage', 'Memory Usage (%)', registry=registry)
firmware = Gauge(f'{METRIC_PREFIX}firmware', 'Firmware Status', registry=registry, labelnames=['version'])
drive_temperature = Gauge(f'{METRIC_PREFIX}drive_temperature', 'Drive Temperature (°C)', registry=registry, labelnames=['slot'])
drive_healthy = Gauge(f'{METRIC_PREFIX}drive_healthy', 'Drive Healthy', registry=registry, labelnames=['slot'])
drive_size = Gauge(f'{METRIC_PREFIX}drive_size', 'Drive Size', registry=registry, labelnames=['slot'])
total_storage = Gauge(f'{METRIC_PREFIX}total_storage', 'Total Storage', registry=registry)
used_storage = Gauge(f'{METRIC_PREFIX}used_storage', 'Used Storage', registry=registry)
free_storage = Gauge(f'{METRIC_PREFIX}free_storage', 'Free Storage', registry=registry)
share = Gauge(f'{METRIC_PREFIX}share', 'Share Size', registry=registry, labelnames=['name', 'quota'])
start_time = Gauge(f'{METRIC_PREFIX}start_time', 'Start Time', registry=registry)
network_interface = Gauge(f'{METRIC_PREFIX}network_interface', 'Network Interface', registry=registry, labelnames=['interface'])
